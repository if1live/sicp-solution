...
; https://github.com/mprentice/sicp/blob/master/ch4/amb.rkt
...
;; TODO:
;; Still needs let from previous exercise.
;; (list (amb 1 2 3) (amb 'a 'b)) produces error:
...
(define (setup-environment)
  (let ((initial-env
    ...
    ;; install a few basic definitions
...
;; Emacs REPL "text is read-only" fix is:
;; (setq geiser-repl-read-only-prompt-p nil)
;; See http://blog.gmane.org/gmane.lisp.scheme.geiser/month=20120501
